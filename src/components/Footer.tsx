                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
                    <div className="col-span-2 lg:col-span-1">
                        ...
                        <div className="flex gap-4">
                            ...
                            <a href="#" className="w-8 h-8 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gray-700 transition-colors">
                                <svg className="h-4 w-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723 10.052 10.052 0 01-3.127 1.195 4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.89 4.89 0 00-.666 2.478c0 1.71.87 3.213 2.188 4.096a4.936 4.936 0 01-2.228-.616v.06a4.926 4.926 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.934 4.934 0 004.6 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
                                </svg>
                            </a>
                            <a href="#" className="w-8 h-8 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gray-700 transition-colors">
                                <svg className="h-4 w-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-400">
                            ...
                            <li><a href="#" className="hover:text-red-500 transition-colors">Browse</a></li>
                            <li><a href="#" className="hover:text-red-500 transition-colors">Categories</a></li>
                            <li><a href="#" className="hover:text-red-500 transition-colors">Top Rated</a></li>
                            <li><a href="#" className="hover:text-red-500 transition-colors">Coming Soon</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-400">
                            ...
                            <li><a href="#" className="hover:text-red-500 transition-colors">Sci-Fi</a></li>
                            <li><a href="#" className="hover:text-red-500 transition-colors">Horror</a></li>
                        </ul>
                    </div>
                </div>
            </div>
